...
public class BeanVendorName {
    ...
    public void setFilter_user_id(String filter_user_id) {
        this.filter_user_id = filter_user_id;
    }

    public String getFilter_frim_name() {
        return filter_frim_name;
    }

    public void setFilter_frim_name(String filter_frim_name) {
        this.filter_frim_name = filter_frim_name;
    }
    ...
    public BeanVendorName() {
    }

    public BeanVendorName(String start_time, String end_time, String start_latitude, String start_longitude, String end_latitude, String end_longitude, String start_location, String end_location, String start_battery_status, String end_battery_status, String company_name, String contact_person_name
