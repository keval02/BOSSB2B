...
public class VendorAllHistoryListAdapter extends BaseAdapter {

    List<BeanHistoryVendorName> vnames = new ArrayList<>();
    ...
    public VendorAllHistoryListAdapter(Context context, List<BeanHistoryVendorName> vnames, Activity activity) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        final BeanHistoryVendorName bvn = vnames.get(position);
        ...
        view = inflater.inflate(R.layout.custom_history_listview, parent, false);
...
*/
    ...
    private void showalertdialog(final int position) {
       ...
       // if(!img_2.equalsIgnoreCase("null")||!img_2.isEmpty()||!img_2.equalsIgnoreCase("")||!img_2.equalsIgnoreCase(null)){
        ...
        d_sales_personname.setText(vnames.get(position).getCompanySalesPersonName());
...
*/
    ...
    public void updateData(List<BeanHistoryVendorName> retailerPersonList) {
