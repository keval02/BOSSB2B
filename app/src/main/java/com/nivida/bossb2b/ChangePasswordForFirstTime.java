...
public class ChangePasswordForFirstTime extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_change_password_for_first_time);
...
pref = new AppPref(getApplicationContext());
        ...
        /*logout = (ImageView) findViewById(R.id.logoutfifty);

        logout.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                AlertDialog.Builder builder1 = new AlertDialog.Builder(ChangePasswordForFirstTime.this);
...
*/
        ...
        btn_change.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (etold_pass.getText().toString().trim().equalsIgnoreCase("")) {
                    ...
                    Toast.makeText(ChangePasswordForFirstTime.this,"Please Enter Old Password",Toast.LENGTH_LONG).show();
                } else if (etold_pass.length() < 6) {
                    Toast.makeText(ChangePasswordForFirstTime.this,"Old Password Required Minimum 6 Character ",Toast.LENGTH_LONG).show();
                    ...
                    //GlobalVariable.CustomToast(ChangePassword.this, "Password is compulsory", getLayoutInflater());
                    Toast.makeText(ChangePasswordForFirstTime.this,"Please Enter New Password",Toast.LENGTH_LONG).show();
                } else if (etnew_pass.length() < 6) {
                    Toast.makeText(ChangePasswordForFirstTime.this,"New Password Required Minimum 6 Character ",Toast.LENGTH_LONG).show();
                    //GlobalVariable.CustomToast(ChangePassword.this, "Password minimum 6 character required", getLayoutInflater());
                } else if (etconf_pass.getText().toString().trim().equalsIgnoreCase("")) {
                    Toast.makeText(ChangePasswordForFirstTime.this,"Please Enter Confirm Password", Toast.LENGTH_LONG).show();
                    ...
                    Toast.makeText(ChangePasswordForFirstTime.this,"Confirm Password did not Match",Toast.LENGTH_LONG).show();
                    ...
                    new changePasswordforFirsttime().execute();
    ...
    public class changePasswordforFirsttime extends AsyncTask<Void,Void,String>
    {
        boolean status;
        ...
        protected void onPreExecute() {
            ...
            try {
                loadingView = new ProgressActivity(
                        ChangePasswordForFirstTime.this, "");
            ...
            try {
                ...
                if (result_1.equalsIgnoreCase("")
                    ...
                    if (date.equalsIgnoreCase("false")) {
                        ...
                        Toast.makeText(ChangePasswordForFirstTime.this,""+Message,Toast.LENGTH_LONG).show();
                        ...
                        pref.setChange_password("0");
                        Log.e("Change Password"  , pref.getChange_password());
                        pref.setPasswordChanged(false);
                        // GlobalVariable.CustomToast(ChangePassword.this,""+Message, getLayoutInflater());
                        Intent i = new Intent(ChangePasswordForFirstTime.this, HomeActivity.class);
    ...
    private void setRefershData() {
        ...
        user_data.clear();
        db = new DatabaseHandler(ChangePasswordForFirstTime.this);
